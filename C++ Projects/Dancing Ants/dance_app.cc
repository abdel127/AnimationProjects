...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
	...
	ballet_special2_.LoadFromAMC(Platform::FindFile("05_09.amc", searchPath_), *ballet_ant_.skeleton_ptr());
	...
	ballet_special3_.TrimFront(230);
	ballet_special3_.TrimBack(200);
	ballet_special3_.CalcRelativeTranslations();

	ballet_special4_.LoadFromAMC(Platform::FindFile("05_10.amc", searchPath_), *ballet_ant_.skeleton_ptr());
	ballet_special4_.TrimFront(280);
	ballet_special4_.TrimBack(200);
	ballet_special4_.CalcRelativeTranslations();

	ballet_special5_.LoadFromAMC(Platform::FindFile("05_20.amc", searchPath_), *ballet_ant_.skeleton_ptr());
